...
<img src="bookstorev1.assets/image-20220530200838987.png" alt="image-20220530200838987" style="zoom:50%;" />

在页面中加入一个app的范围框<div id="app">;

用户名输入框和密码输入框的双向绑定v-model="username"和v-model="password";

登录按钮的效果的设置@click="loginCheck";
